...
$query = "INSERT INTO orders (user_id, adresa, oras, judet, tara, cod_postal, telefon, total, programare) 
  			  VALUES('$customer_id', '$adresa', '$oras', '$judet', '$tara', '$cod_postal', '$nr_telefon', '$total', '$programare')";
